...
var primitive_builtin_functions = 
{
    "+":function(param_array)
        {
            var output = new Toy_Number(0, 1, RATIO);
    ...
    "numerator_": function(stack_param){ 
    ...
    "denominator_": function(stack_param){ 
        if(stack_param[0] instanceof Toy_Number)
